 ...
 * Description: YITH WooCommerce EU VAT allows you to be fully compliance with EU VAT laws, storing chceckout data and filling the EU VAT MOSS report for digital goods.
 * Version: 1.2.1
 * Author: Yithemes
...
function yith_ywev_install_woocommerce_admin_notice() {
	?>
	<div class="error">
		<p><?php _e( 'YITH WooCommerce EU VAT is enabled but not effective. It requires WooCommerce in order to work.', 'ywev' ); ?></p>
	</div>
<?php
}
...
function yith_ywev_install_free_admin_notice() {
	?>
	<div class="error">
		<p><?php _e( 'You can\'t activate the free version of YITH WooCommerce EU VAT while you are using the premium one.', 'ywev' ); ?></p>
	</div>
<?php
}
...
if ( ! defined( 'YITH_YWEV_VERSION' ) ) {
	define( 'YITH_YWEV_VERSION', '1.2.1' );
}
